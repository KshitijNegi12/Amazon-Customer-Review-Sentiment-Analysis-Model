...
## Introduction
This web application allows users to analyze sentiments of Amazon reviews using a trained Naive Bayes model. By crawling product latest 10 reviews, it determines whether the sentiment is positive or negative and provides confidence scores for each prediction.
